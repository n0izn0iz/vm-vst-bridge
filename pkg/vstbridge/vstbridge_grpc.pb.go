...
type VSTBridgeClient interface {
	...
	// Parameters
	GetParameter(ctx context.Context, in *GetParameter_Request, opts ...grpc.CallOption) (*GetParameter_Reply, error)
	SetParameter(ctx context.Context, in *SetParameter_Request, opts ...grpc.CallOption) (*SetParameter_Reply, error)
}
...
func (c *vSTBridgeClient) GetParameter(ctx context.Context, in *GetParameter_Request, opts ...grpc.CallOption) (*GetParameter_Reply, error) {
	out := new(GetParameter_Reply)
	err := c.cc.Invoke(ctx, "/vstbridge.VSTBridge/GetParameter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vSTBridgeClient) SetParameter(ctx context.Context, in *SetParameter_Request, opts ...grpc.CallOption) (*SetParameter_Reply, error) {
	out := new(SetParameter_Reply)
	err := c.cc.Invoke(ctx, "/vstbridge.VSTBridge/SetParameter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VSTBridgeServer interface {
	...
	// Parameters
	GetParameter(context.Context, *GetParameter_Request) (*GetParameter_Reply, error)
	SetParameter(context.Context, *SetParameter_Request) (*SetParameter_Reply, error)
...
func (UnimplementedVSTBridgeServer) GetParameter(context.Context, *GetParameter_Request) (*GetParameter_Reply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetParameter not implemented")
}
func (UnimplementedVSTBridgeServer) SetParameter(context.Context, *SetParameter_Request) (*SetParameter_Reply, error) {
...
func _VSTBridge_GetParameter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetParameter_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VSTBridgeServer).GetParameter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vstbridge.VSTBridge/GetParameter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VSTBridgeServer).GetParameter(ctx, req.(*GetParameter_Request))
	}
	return interceptor(ctx, in, info, handler)
}

func _VSTBridge_SetParameter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetParameter_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VSTBridgeServer).SetParameter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vstbridge.VSTBridge/SetParameter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VSTBridgeServer).SetParameter(ctx, req.(*SetParameter_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _VSTBridge_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VSTBridge_GetParameter_Handler,
		},
		{
			MethodName: "SetParameter",
			Handler:    _VSTBridge_SetParameter_Handler,
		},
	},
